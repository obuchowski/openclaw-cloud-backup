...
Backs up `~/.openclaw` (the OpenClaw state directory). That's it. Don't ask the user *what* to back up — it's always the OpenClaw state.

- **Local archive** is always created at `~/.openclaw/backups/`
